...
export default class MovieCard extends Component {
  // let genres = () => {
    ...
    // this.props.film.genres.map(genre => true).join
  // }
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardBack title={this.props.title} genres={this.props.genres.map(genre => genre).join(",")} IMDBRating={this.props.IMDBRating}/>
      </div>
    )
  }
}
